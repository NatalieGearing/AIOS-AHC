...
This is Natalie Gearing's AIOS workspace for **Affordable House Corp** — a 30-year residential builder specializing in turnkey investment property construction (rooming accommodation, dual occupancy, land subdivisions, pre-fab houses). Natalie runs marketing and website creation for the business, and this workspace is currently focused on rebuilding the company website and brochures, with wider AI-driven operations automation planned for later.

The AIOS is a layer of AI automation wrapped around your business, powered by plug-and-play modules you install one at a time.
...
- **User**: Natalie Gearing, marketing and website lead at Affordable House Corp. Defines goals around the website rebuild, brochure creation, and (later) wider business automation, and directs work through commands
...
│   ├── dashboard.md         # Operational hub — projects, actions, waiting-for at a glance
│   ├── inbox.md              # Raw capture bucket, processed to zero with /process
│   ├── projects.md          # Master project list
│   ├── next-actions.md      # Actions organized by context (@me, @claude, @calls, etc.)
...
│   └── website/             # Affordable House Corp website (Next.js + TypeScript + Tailwind)
├── reference/               # Templates, examples, reusable patterns (includes gtd-methodology.md)
...
**Business:** Affordable House Corp — 30-year residential builder, market leader in rooming accommodation, turnkey construction for property investors (rooming accommodation, dual occupancy, subdivisions, pre-fab), circa $100m turnover, team of 50
**Role:** Natalie Gearing, marketing and website creation (solo)
**Current focus:** Rebuild the company website (custom build calculator, colour selection tool, strong SEO) and finalize editable Canva brochures, to present a more professional image than competitors and the outdated current site
**Key metric to watch:** Website traffic, SEO keyword rankings, and leads/enquiries generated once the new site is live

---

## Website Project

The Affordable House Corp website lives in `outputs/website/` — a Next.js (TypeScript + Tailwind CSS) site. Full build plan: `plans/2026-07-13-affordable-house-corp-website.md`. See `outputs/website/README.md` for local dev, known placeholders (calculator pricing, colour palette, logo, domain), and deployment steps.

To run it locally: `cd outputs/website && npm run dev` (Node.js must be on PATH — see the README if it isn't yet).
...
**Purpose:** Empty the GTD inbox to zero using the GTD decision tree.

Routes each captured item to projects, next-actions, waiting-for, someday-maybe, or trash.

### /review

**Purpose:** Guided weekly GTD review (30-60 minutes, Friday recommended).

Processes inbox, walks through all project/action lists, scans areas and someday-maybe, rebuilds the dashboard.
