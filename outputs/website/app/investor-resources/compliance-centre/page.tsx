...
export const metadata = buildMetadata({
  ...
  description:
    "Compliance information and resources for property investors, from Affordable House Corp.",
});
  ...
  return (
    <div className="mx-auto max-w-3xl px-6 py-20 text-center">
      ...
      <p className="mx-auto mt-6 max-w-xl text-brand-gray">
        We&apos;re building out a dedicated compliance centre covering
        regulations, certifications and requirements relevant to investment
        property builds. This page is coming soon.
      </p>
