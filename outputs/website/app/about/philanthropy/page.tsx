...
export const metadata = buildMetadata({
  title: "Philanthropy",
  description:
    "Affordable House Corp's community and philanthropic initiatives.",
});
  ...
  return (
    <div className="mx-auto max-w-3xl px-6 py-20 text-center">
      ...
      <p className="mx-auto mt-6 max-w-xl text-brand-gray">
        We&apos;re putting together a page on the community initiatives and
        causes Affordable House Corp supports. This page is coming soon.
      </p>
