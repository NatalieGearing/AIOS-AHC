...
export const metadata = buildMetadata({
  ...
  description: "Watch Affordable House Corp's videos on YouTube.",
});
  ...
  return (
    <div className="mx-auto max-w-3xl px-6 py-20 text-center">
      ...
      <p className="mx-auto mt-6 max-w-xl text-brand-gray">
        We&apos;re putting together a page linking to our YouTube channel and
        video library. This page is coming soon.
      </p>
